...
File: app/services/ai_service.py (UPDATE EXISTING FILE)
"""
...
class AIService:
    ...
    async def generate_strategy(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Try to parse as JSON, if fails return structured dict
            try:
                ...
                strategy = {
                    "campaigns": {
                        ...
                        "social_media": {
                            ...
                            "content_mix": "Educational 40%, Promotional 30%, Engaging 30%"
                        }
                    },
                    "platform_recommendations": [
                        {
                            "platform": "Meta Ads",
                            "reason": "Best for B2C targeting and visual content",
                            "budget": "40% of ad spend"
                        },
                        {
                            "platform": "Google Ads",
                            "reason": "High-intent search traffic",
                            "budget": "35% of ad spend"
                        },
                        {
                            "platform": "LinkedIn Ads",
                            "reason": "B2B professional targeting",
                            "budget": "25% of ad spend"
                        }
                    ],
                    "creative_formats": [
                    ...
                    "automation_tools": [
                        "Meta Business Suite for social scheduling",
    ...
    async def generate_differentiators(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"AI Differentiators Generation Error: {e}")
    ...
    async def generate_timeline(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"AI Timeline Generation Error: {e}")
    ...
    def _get_fallback_strategy(self) -> Dict[str, Any]:
        ...
        return {
            "campaigns": {
                ...
                "email_marketing": {"frequency": "2-3 per week"},
                "seo": {"focus": "On-page + Content"},
                "social_media": {"platforms": ["Instagram", "Facebook", "LinkedIn"]}
            },
            "note": "Generated using fallback template"
        }
    ...
    def _get_fallback_differentiators(self) -> Dict[str, Any]:
        ...
        return {
            "differentiators": [
                {
                    "title": "AI-Powered Automation",
                    "description": "Faster deployment with advanced automation"
                },
                {
            ...
            "phases": [
                {
                    ...
                    "duration": "Week 1-2",
                    "deliverables": ["Strategy document", "Analytics setup"]
                },
                {
                    "phase": "Launch",
                    "duration": "Week 3-6",
                    "deliverables": ["Live campaigns", "Content calendar"]
                },
                {
                    "phase": "Growth",
                    "duration": "Month 3-6",
                    "deliverables": ["Scaled campaigns", "ROI reports"]
                }
            ]
        }